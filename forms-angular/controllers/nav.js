...
formsAngular.controller('NavCtrl',
  ['$scope', '$data', '$location', '$filter', '$locationParse', '$controller', 'urlService', 'cssFrameworkService', '$http',
    function ($scope, $data, $location, $filter, $locationParse, $controller, urlService, cssFrameworkService, $http) {
  ...
  $http.get("/model_names").success(function(data){
